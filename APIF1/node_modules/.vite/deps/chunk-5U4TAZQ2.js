...
function supportNodeRef(node2) {
  if (!(0, import_react8.isValidElement)(node2)) {
    return false;
  }
...
function generate2(node2, key, rootProps) {
  if (!rootProps) {
    return import_react16.default.createElement(node2.tag, _objectSpread2({
      key
  ...
  return import_react16.default.createElement(node2.tag, _objectSpread2(_objectSpread2({
    key
...
var useInsertStyles = function useInsertStyles2(eleRef) {
  var _useContext = (0, import_react16.useContext)(Context_default), csp = _useContext.csp, prefixCls = _useContext.prefixCls;
...
var Icon = React34.forwardRef(function(props, ref) {
  ...
  var _React$useContext = React34.useContext(Context_default), _React$useContext$pre = _React$useContext.prefixCls, prefixCls = _React$useContext$pre === void 0 ? "anticon" : _React$useContext$pre, rootClassName = _React$useContext.rootClassName;
  ...
  var _normalizeTwoToneColo = normalizeTwoToneColors(twoToneColor), _normalizeTwoToneColo2 = _slicedToArray(_normalizeTwoToneColo, 2), primaryColor = _normalizeTwoToneColo2[0], secondaryColor = _normalizeTwoToneColo2[1];
  return React34.createElement("span", _extends({
    role: "img",
...
var BarsOutlined_default2 = React35.forwardRef(BarsOutlined2);
...
var LeftOutlined_default2 = React36.forwardRef(LeftOutlined2);
...
var RightOutlined_default2 = React37.forwardRef(RightOutlined2);
...
var SiderContext = React38.createContext({});
var generateId = (() => {
  let i = 0;
  return function() {
...
var Sider = React38.forwardRef((props, ref) => {
  const {
  ...
  const renderSider = () => {
    ...
    const zeroWidthTrigger = parseFloat(String(collapsedWidth || 0)) === 0 ? React38.createElement("span", {
      onClick: toggle,
    ...
    }, trigger || React38.createElement(BarsOutlined_default2, null)) : null;
    const iconObj = {
      expanded: reverseArrow ? React38.createElement(RightOutlined_default2, null) : React38.createElement(LeftOutlined_default2, null),
      collapsed: reverseArrow ? React38.createElement(LeftOutlined_default2, null) : React38.createElement(RightOutlined_default2, null)
    };
    const status = collapsed ? "collapsed" : "expanded";
    const defaultTrigger = iconObj[status];
    const triggerDom = trigger !== null ? zeroWidthTrigger || React38.createElement("div", {
    ...
    return React38.createElement("aside", Object.assign({
      className: siderCls
    }, divProps, {
      style: divStyle,
      ref
  ...
  return React38.createElement(SiderContext.Provider, {
    value: contextValue
  }, renderSider());
});
if (true) {
...
function generator(_ref) {
  ...
  return (BasicComponent) => {
    const Adapter = React39.forwardRef((props, ref) => React39.createElement(BasicComponent, Object.assign({
      ref,
      suffixCls,
      tagName
    }, props)));
...
var Basic = React39.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    suffixCls,
    className,
  ...
  return wrapSSR(React39.createElement(TagName, Object.assign({
    className: (0, import_classnames4.default)(customizePrefixCls || prefixWithSuffixCls, className, hashId),
    ref
  }, others)));
});
var BasicLayout = React39.forwardRef((props, ref) => {
  const {
    direction
  } = React39.useContext(ConfigContext);
  const [siders, setSiders] = React39.useState([]);
  const {
    prefixCls: customizePrefixCls,
    className,
    rootClassName,
  ...
  return wrapSSR(React39.createElement(LayoutContext.Provider, {
    value: contextValue
  }, React39.createElement(Tag, Object.assign({
    ref,
    className: classString,
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5U4TAZQ2.js.map
